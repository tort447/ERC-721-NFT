...
contract SH512A is Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, ERC721URIStorageUpgradeable, ERC721PausableUpgradeable, OwnableUpgradeable, ERC721BurnableUpgradeable, EIP712Upgradeable, ERC721VotesUpgradeable {
    ...
    function initialize(address initialOwner) initializer public {
        __ERC721_init("SH512A", "SHA");
        __ERC721Enumerable_init();
        __ERC721URIStorage_init();
        __ERC721Pausable_init();
        __Ownable_init(initialOwner);
        __ERC721Burnable_init();
        __EIP712_init("SH512A", "1");
        __ERC721Votes_init();
    }
    ...
    require(msg.value >= 0.01 ether, "Insufficient funds"); // Мінімальна оплата
    uint256 tokenId = _nextTokenId++;
